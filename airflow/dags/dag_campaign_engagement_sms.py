...
with DAG(
    dag_id="silver_campaign_engagement_sms",
    default_args=default_args,
    description="Build SMS campaign engagement metrics (Silver layer)",
    schedule_interval=None,   
    start_date=days_ago(1),
    catchup=False,
    tags=["silver", "sms", "campaign", "iceberg"],
) as dag:

    run_silver_campaign_engagement_sms =SparkSubmitOperator(
        task_id="campaign_engagement_sms",
        application="/opt/airflow/spark_jobs/silver_campaign_engagement_sms.py",
        conn_id="spark_local",
    ...
    run_silver_campaign_engagement_sms
